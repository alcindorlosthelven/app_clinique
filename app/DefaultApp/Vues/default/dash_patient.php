                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="<?= \app\DefaultApp\DefaultApp::autre("img_integra.jpeg") ?>" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?= \app\DefaultApp\DefaultApp::autre("img_integra.jpeg") ?>" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?= \app\DefaultApp\DefaultApp::autre("img_integra.jpeg") ?>" alt="Third slide">
                        </div>
                    </div>
